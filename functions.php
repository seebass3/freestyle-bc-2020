...
function the_breadcrumb() {
	...
	// Start the breadcrumb with a link to your homepage
        ...
        echo "<img src='".$url."/images/FreestyleBCBadge.png" .  "' alt='Home' ' height='25' >";
        echo '</a>' . $sep;
...
//     register_sidebar( array(
//         'name'          => 'Latest News Widget Area',
//         'id'            => 'latest-new-widget',
//         'before_widget' => '<div class="news-widget">',
//         'after_widget'  => '</div>',
//         'before_title'  => '<h1 class="news-title">',
//         'after_title'   => '</h1>',
//     ) );
...
function wp_bootstrap_starter_scripts() {
	...
	wp_enqueue_style( 'wp-bootstrap-starter-style', get_stylesheet_uri(), array(), rand(111,9999), 'all');
    //Color Scheme
...
/**
 * Remove Category: from Archives and add News
 */
...
function create_team_cpt() {
	...
	$testDiscipline = array(
		"label" => "Discipline",
		"singular_label" => "team-disc",
		'public' => true,
		'hierarchical' => true,
		'show_ui' => true,
		'show_in_nav_menus' => false,
	...
	register_taxonomy( 'team-disc', 'team', $testDiscipline );
	register_taxonomy( 'team-cat', 'team', $testiArgs );
    flush_rewrite_rules(false);

}
add_action( 'init', 'create_team_cpt', 0 );

add_filter( 'pre_get_posts', 'custom_change_team_posts_per_page' );

function custom_change_team_posts_per_page( $query ) {

    if ( $query->is_post_type_archive( 'team' ) && ! is_admin() && $query->is_main_query() ) {
